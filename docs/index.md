...
- [3. Présentation du gestionnaire de listes](#presentation-du-gestionnaire-de-listes)

- [4. Présentation d’une liste](#presentation-dune-liste)

- [5. Création de listes](#creation-de-listes)
...
- [6. Ajout d’éléments dans une liste](#ajout-delements-dans-une-liste)
	...
	- [6.2 Via : « glissé & déposé »](#via-glisse-dépose)
		...
		- [6.2.1 D’une liste A vers la liste « sélection » :](#dune-liste-a-vers-la-liste-sélection)
		
		- [6.2.2 De la liste « Sélection » vers une liste A](#de-la-liste-sélection-vers-une-liste-a)

		- [6.2.3 D’une liste A vers une liste B](#dune-liste-a-vers-une-liste-b)
						

- [7. Suppression d’éléments dans une liste](#suppression-delements-dans-une-liste)

	- [7.1 Via le menu contextuel](#via-le-menu-contextuel)

	- [7.2 Via : « glissé & déposé »](#via-glisse-dépose)

- [8. Ouverture de la table attributaire](#ouverture-de-la-table-attributaire)
...
<div  style="background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="presentation-du-gestionnaire-de-listes" style="color: white;margin:0;" >3. Présentation du gestionnaire de listes</h2>
</div>
...
<div  style="background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="presentation-dune-liste" style="color: white;margin:0;" >4. Présentation d’une liste</h2>
</div>
...
<div  style="background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="creation-de-listes" style="color: white;margin:0;" >5. Création de listes</h2>
</div>
...
<div  style="background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="ajout-delements-dans-une-liste" style="color: white;margin:0;" >6. Ajout d’éléments dans une liste</h2>
</div>
...
<div  style="font-size: 10px;background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="via" style="color: white;margin:0;" >6.1 via<img src="images/image4.png" style="width:0.67847in;height:0.18264in" /></h2>
</div>
...
<div  style="font-size: 10px;background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="via-glisse-dépose" style="color: white;margin:0;" >6.2 Via : « glissé & déposé »</h2>
</div>
...
<div  style="font-size: 10px;background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="dune-liste-a-vers-la-liste-sélection" style="color: white;margin:0;" >6.2.1 D’une liste A vers la liste « sélection » :</h2>
</div>
...
<div  style="font-size: 10px;background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="de-la-liste-sélection-vers-une-liste-a" style="color: white;margin:0;" >6.2.2 De la liste « Sélection » vers une liste A</h2>
</div>
...
<div  style="font-size: 10px;background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="dune-liste-a-vers-une-liste-b" style="color: white;margin:0;" >6.2.3 D’une liste A vers une liste B</h2>
</div>
...
<div  style="background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="suppression-delements-dans-une-liste" style="color: white;margin:0;" >7. Suppression d’éléments dans une liste</h2>
</div>


	
<div  style="font-size: 10px;background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="via-le-menu-contextuel" style="color: white;margin:0;" >7.1 Via le menu contextuel</h2>
</div>
...
<div  style="background-color: #00ADC5; border: 1px solid black; padding: 5px; text-align: justify;margin-bottom:10px;">
  <h2 id="ouverture-de-la-table-attributaire" style="color: white;margin:0;" >8. Ouverture de la table attributaire</h2>
</div>
